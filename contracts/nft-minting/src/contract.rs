...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        ...
        HandleMsg::MintAdmin { amount, mint_for } => try_mint_admin(deps, env, mint_for, amount),
        HandleMsg::Mint { amount } => try_mint_native(deps, env, amount),
...
fn receive<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        ReceiveMsg::Mint {
            amount_to_mint,
            mint_for,
        } => try_mint_with_token(deps, env, amount, mint_for, amount_to_mint, from),
    }
}
